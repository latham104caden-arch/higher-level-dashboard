...
const METRICS = [
  { name: 'CPM', full: 'Cost Per 1,000 Impressions', plain: 'How much it costs to show your ad to 1,000 people.', why: 'A lower CPM means your budget goes further — more people see your ad for less money. Good for local businesses: $5–$15. Ecommerce: $15–$40.', good: 'Lower is better. Under $20 is healthy for most campaigns.', color: '#5E6AD2' },
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div
                  ...
                  style={{ background: m.color + '0d', color: m.color, border: `1px solid ${m.color}1f` }}
                >
                  {m.good}
                </div>
              </div>
