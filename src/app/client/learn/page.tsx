...
const METRICS = [
  { name: 'CPM', full: 'Cost Per 1,000 Impressions', emoji: '👁️', plain: 'How much it costs to show your ad to 1,000 people.', why: 'A lower CPM means your budget goes further — more people see your ad for less money. Good for local businesses: $5–$15. Ecommerce: $15–$40.', good: 'Lower is better. Under $20 is healthy for most campaigns.', color: '#A0CFFF' },
  { name: 'CTR', full: 'Click-Through Rate', emoji: '🎯', plain: 'The percentage of people who saw your ad and clicked on it.', why: "A high CTR means your ad is grabbing attention. A low CTR means the ad isn't connecting with your audience.", good: 'Above 1% is average. Above 2% is good. Above 3% means your creative is working.', color: '#45B69C' },
  { name: 'CPC', full: 'Cost Per Click', emoji: '💰', plain: 'How much you pay each time someone clicks your ad.', why: "Lower CPC means more people are visiting your site for the same budget. High CPC usually means your ad isn't relevant enough.", good: 'Under $1.50 is solid. Under $0.50 is excellent.', color: '#FFB800' },
  { name: 'ROAS', full: 'Return on Ad Spend', emoji: '📈', plain: 'For every $1 you spend on ads, how many dollars you make back.', why: "This is the most important number for ecommerce. 1x means you're breaking even. 2x means you're doubling your money.", good: 'Above 2x is profitable. 3x+ is where you start to scale hard.', color: '#21D19F' },
  { name: 'CPL', full: 'Cost Per Lead', emoji: '🎯', plain: 'How much it costs to get one lead or inquiry from your ads.', why: 'If a job is worth $300 to you, paying $50 per lead is great. Paying $200 per lead is a problem.', good: 'Target: 10–20% of your average job value.', color: '#21D19F' },
  { name: 'Impressions', full: 'Total Impressions', emoji: '📣', plain: 'The total number of times your ad was shown to people.', why: "More impressions means more people seeing your brand. But impressions alone don't mean much — you need clicks and actions.", good: 'Track trends. If impressions drop, your budget ran out or audience is too narrow.', color: '#A0A4B8' },
  { name: 'Frequency', full: 'Ad Frequency', emoji: '🔁', plain: 'How many times the average person has seen your ad.', why: "Seeing an ad once usually isn't enough to act. But 10+ times gets annoying. High frequency + low results = need new creative.", good: '1–3 is ideal. Over 4–5 means you need fresh ads or a bigger audience.', color: '#F59E0B' },
  { name: 'CTR vs CVR', full: 'Click Rate vs Conversion Rate', emoji: '⚡', plain: 'CTR measures who clicked. Conversion rate measures who actually bought or contacted you after clicking.', why: "You can have great CTR (people click) but terrible conversion rate (people leave without buying). That means the problem is your website, not the ad.", good: 'Aim for 2%+ website conversion rate. If people click but don\'t buy, focus on your landing page.', color: '#EF4444' },
]
            ...
            {METRICS.map(m => (
              ...
              >
                ...
                <div className="flex items-start gap-4 relative">
                  <div className="text-2xl mt-0.5">{m.emoji}</div>
